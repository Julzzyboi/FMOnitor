...
import '../../widgets/common/dot_grid.dart';
import '../../widgets/common/google_sign_in_button.dart';
import '../../widgets/common/wave_footer.dart';
...
class _LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _privacyTap = TapGestureRecognizer()..onTap = () => showComingSoon(context, 'Privacy Policy');
    _termsTap = TapGestureRecognizer()..onTap = () => showComingSoon(context, 'Terms and Conditions');
  }
